...
export interface KanbanAddRecDialogProps {
  experimentId?: string;
...
export function KanbanAddRecDialog({ experimentId: fixedExpId, initialValues, onDone, onCancel }: KanbanAddRecDialogProps) {
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <Level level="rec" />
            <h2 style={{ fontSize: 16, fontWeight: 600, color: HF.ink, margin: 0 }}>{isEdit ? 'Edit recommendation' : 'Add recommendation'}</h2>
          </div>
          <button
            onClick={onCancel}
            style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
          ...
          <input
            ...
            placeholder="State the action or change to make"
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
          ...
          <textarea
            ...
            placeholder="Explain the rationale or expected outcome (optional)"
            rows={3}
            style={{
              background: HF.bgSubtle, border: `1px solid ${HF.border}`,
